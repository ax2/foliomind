...
import { normalizeWatchlistItem, sortWatchlistItems, WATCHLIST_SORT_OPTIONS } from "../lib/watchlist.js";
...
export function WatchlistSidebar() {
  ...
  return <aside className="watchlist-sidebar">
    <div className="sidebar-heading"><h2>自选</h2><div><button aria-label="添加自选" onClick={openDialog}><Plus size={19} /></button><button aria-label="更多"><DotsThree size={20} /></button></div></div>
