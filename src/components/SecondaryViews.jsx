...
function marketSummaryValue(field, value) {
  ...
  if (field === "change" || field === "turnoverRate") return formatPercent(value);
...
export function MarketView() {
  ...
  const returnedQuotes = watchlist.filter((item) => isValidQuotePrice(liveQuotes[item.symbol]?.price));
