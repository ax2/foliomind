...
export function SettingsView() {
  ...
  const syncModels = () => run(async () => { await saveIntegrationSettings(form); const value = await syncQVerisModels(); setStatus((current) => ({ ...current, settings: value })); return value; }, "模型目录已从 QVeris 网关同步");
