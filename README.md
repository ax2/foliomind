...
- 个股盯盘规则、事件时间线和开关状态。
- 公司事件日历：按自选标的展示未来 90 天真实分红、拆股、股东会和财报日期，支持范围筛选、关键词搜索和来源追溯；无数据时保持明确空态。
