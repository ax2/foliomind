...
4. Copilot: user bubble and timestamp, analysis summary, four key points, three-tool audit card, event card, composer, and disclaimer match the source content order and density.
...
- Fixes added the average line and volume series, restored company introduction and the right-side monitoring event, widened the Copilot column, added message metadata and the fourth risk point, and increased the chart height.
