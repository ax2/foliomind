...
test("extracts provider and model gateway costs without inventing missing charges", () => {
  ...
  assert.deepEqual(costSummary([{ type: "qveris", cost: { amount: 0.1, unit: "credits" } }, { type: "model", cost: { amount: 0.2, unit: "credits" } }, { type: "model" }]), { qverisCalls: 1, qverisCost: 0.1, qverisCostKnown: 1, modelCalls: 2, modelCost: 0.2, modelCostKnown: 1, units: ["credits"] });
});
