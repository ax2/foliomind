...
check("CAP 能力工作台", developerPanel.includes("调用测试") && developerPanel.includes("参数 Schema") && developerPanel.includes("返回字段") && developerPanel.includes("刷新能力目录") && developerPanel.includes("capabilityToolSchema") && developerPanel.includes("复制 Tool Schema") && localHost.includes("BUILTIN_CAPABILITY_CATALOG") && styles.includes("min(1320px"), "开发面板必须提供大尺寸能力目录、稳定 schema、真实调用测试和 Skill Tool 导出");
